...
def dense_to_some_hot(labels_dense, num_classes=140):
    ...
    raise Exception("TODO dense_to_some_hot")
...
if __name__ == "__main__":
    ...
    maybe_download(Source.DIGIT_SPECTROS, 'gogo')
    maybe_download(Source.DIGIT_WAVES, 'gogo')
    maybe_download(Source.NUMBER_IMAGES, 'gogo')
    maybe_download(Source.NUMBER_WAVES, 'gogo')
